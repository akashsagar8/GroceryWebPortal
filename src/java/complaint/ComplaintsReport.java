     ...
     try
     {
        ...
        while(rs.next())
        {
        	...
        	for(int i=1;i<=mt.getColumnCount();i++)
               ...
               if(!rs.getString(6).equals("RESOLVED"))
                  out.println("<td><a href=UpdComplaints.jsp?id="+rs.getString(1)+"><span class='glyphicon glyphicon-edit'></span></a> | <span class='glyphicon glyphicon-trash'></span");
               else
