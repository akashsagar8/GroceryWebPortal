...
public class UserComplaintsReport extends HttpServlet {
  ...
  protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
     ...
     try
     {
    	ResultSet rs = db.UserDAO.getRef().userComplaintsReport(uid);
        ...
        while(rs.next())
        {
        	...
        	for(int i=1;i<=mt.getColumnCount();i++)
                ...
                if(uid.equals("ADMIN"))
          	   out.println("<td><a href=UpdComplaints.jsp?id="+rs.getString(1)+"><span class='glyphicon glyphicon-edit'></span></a>");
          	 //  out.println("<td><a href=UpdComplaints.jsp?id="+rs.getString(1)+"><span class='glyphicon glyphicon-edit'></span></a> | <a href=DeleteComplaint?id="+rs.getString(1)+"><span class='glyphicon glyphicon-trash'></span</a>");
          	   ...
          	   out.println("<td><a href=DeleteComplaint?id="+rs.getString(1)+"><span class='glyphicon glyphicon-trash'></span</a>");
            out.println("</tr>");
        }
        out.println("</tbody>");
        out.println("</table>");
