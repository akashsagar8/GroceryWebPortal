       ...
       <form action="ProfileAction" role="form" method="post" class="frm" style="padding-left:50px;padding-right:50px;">
          <table class="table table-md" width="100%"> 
           <tbody>
            ...
            %>
            <tr>
                <td class="lbl">Name</td><td><input type="text" disabled name="name" value="<%=rs.getString(1) %>" class="form-control" required /></td>
                <td class="lbl">D.O.B.</td><td><input type="date" disabled name="dob"  value="<%=rs.getString(3) %>" max="2004-12-31" min="1947-08-15" class="form-control" required /></td>
            </tr>
               <tr>
                 <td class="lbl">Mobile</td><td><input type="text" disabled name="mobile"  value="<%=rs.getString(4) %>" class="form-control" required /></td>
                 <td class="lbl">Mailid</td><td><input type="text" disabled name="mailid"  value="<%=rs.getString(5) %>" class="form-control" required /></td>
            </tr>
            <tr>
               <td colspan="4"><input type="submit" disabled value="Update Profile" class="btn btn-lg btn-primary btn-block" /> </td>
            </tr>    
            <tr>
               <td colspan="4"><%
