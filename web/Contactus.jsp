    ...
    if(document.getElementById("mob").value.length!=10)
 	{
  	...
  	{
  		alert("Sorry Contact Message should be Min 15 Charactors, Plz Enter valid Contact us message");
  		return false;
  	}
 	else return true;
 }
...
<div style="margin-top:5px">
  <img src="images/contact.jpg" style="width:100%;height:150px;margin-top:0px;border-radius:2px;box-shadow:0px 0px 1px black" />
</div>
...
<p style="margin-left:4%;margin-right:4%">
      <img src="images/contctus.jpg" style="height:120px;width:180px;"></p>
...
<td width="50%">
<div style="width:100%;min-height:400px;color:Black  ">
<form action="ContactAction" method="post" onsubmit="return validateMe()">
 ...
 <tr><td style="text-align:right;">Contact No:</td><td><input type=number id="mob" name=mobile class="form-control" placeholder="Enter ur mobile" required/> </td> </tr>
